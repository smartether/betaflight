...
static const OSD_Entry cmsx_menuPowerEntries[] =
{
    ...
    { "V METER", OME_TAB, NULL, &(OSD_TAB_t){ &batteryConfig_voltageMeterSource, VOLTAGE_METER_COUNT - 1, (uint8_t*)(void*)voltageMeterSourceNames }, REBOOT_REQUIRED },
    { "I METER", OME_TAB, NULL, &(OSD_TAB_t){ &batteryConfig_currentMeterSource, CURRENT_METER_COUNT - 1, (uint8_t*)(void*)currentMeterSourceNames }, REBOOT_REQUIRED },
