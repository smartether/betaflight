...
static const OSD_Entry cmsx_menuPowerEntries[] =
{
    ...
    { "V METER", OME_TAB, NULL, &(OSD_TAB_t){(uint8_t*)(void*) &batteryConfig_voltageMeterSource, VOLTAGE_METER_COUNT - 1, voltageMeterSourceNames }, REBOOT_REQUIRED },
    { "I METER", OME_TAB, NULL, &(OSD_TAB_t){(uint8_t*)(void*) &batteryConfig_currentMeterSource, CURRENT_METER_COUNT - 1, currentMeterSourceNames }, REBOOT_REQUIRED },
